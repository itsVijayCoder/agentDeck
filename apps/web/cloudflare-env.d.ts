/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 48ce01b0af7295ac3dbc99ce4b64d8a4)
...
interface __BaseEnv_CloudflareEnv {
	...
	AGENTDECK_QUEUE: Queue;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	SESSION_HUB: DurableObjectNamespace<import("./worker").SessionHub>;
	WORKER_SELF_REFERENCE: Service<typeof import("./worker").default>;
	RUN_WORKFLOW: Workflow<Parameters<import("./worker").RunWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "SessionHub";
	}
